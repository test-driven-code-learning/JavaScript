require('../../02.call_apply_bind/2.3')
...
test('传入原始值, 上下文指向原始值的包装对象', () => {
  expect(printString.myBind('string')()).toBe(true)
  expect(printNumber.myBind(123)()).toBe(true)
  expect(printBoolean.myBind(true)()).toBe(true)
})


test('上下文改变成功', () => {
  expect(print.myBind(obj)()).toBe('lisa20')
})
